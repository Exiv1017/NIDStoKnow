        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          <div className="md:col-span-7 lg:col-span-8">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 font-medium max-w-2xl">
              Log in to continue your journey in network intrusion detection. Access your personalized learning path and track your progress in becoming a cybersecurity expert.
            </p>
          </div>
