        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          <div className="md:col-span-7 lg:col-span-8">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 font-medium max-w-2xl">
              Share your expertise and help shape the next generation of cybersecurity professionals. Sign up to create and manage learning modules.
            </p>
          </div>

          <div className="md:col-span-5 lg:col-span-4 -mt-12">
            <div className="">
              <h2 className="text-2xl font-semibold text-[#1E5780] mb-2">Create Instructor Account</h2>
              {success ? (
                <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-2 rounded mb-4">
                  Account created! Please wait for admin approval. You will be redirected to the login page shortly.
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                    />
                    <p className="text-[11px] text-gray-500 mt-1">Format: firstname.lastname@lspu.edu.ph (auto-generated).</p>
                  </div>
                  <div>
